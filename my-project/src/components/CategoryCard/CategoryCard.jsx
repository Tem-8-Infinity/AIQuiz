...
const CategoryCard = ({ category }) => {
  ...
  return (
      ...
      role="button"
      className="rounded flex gap-2 items-center flex-grow justify-center bg-gradient-to-br from-blue-500 to-teal-200 transition ease-in-out duration-[700ms] hover:shadow-2xl p-2 h-[250px]">
