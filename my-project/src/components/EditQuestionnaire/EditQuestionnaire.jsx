    ...
    >
      ...
      <div className="flex flex-col gap-5 pl-5 ">
        <input
          ...
          value={questionnaire.correctAnswer}
          onChange={(e) => {
            setQuestionnaire({
              ...questionnaire,
        ...
        <input
          ...
          value={questionnaire.incorrectAnswers[0]}
          onChange={(e) => {
            setQuestionnaire({
              ...questionnaire,
              incorrectAnswers: [
                e.target.value,
                questionnaire.incorrectAnswers[1],
                questionnaire.incorrectAnswers[2],
              ],
            });
          }}
        ...
        <input
          ...
          type="text"
          placeholder="Write The Wrong Answer"
          value={questionnaire.incorrectAnswers[1]}
          onChange={(e) => {
            setQuestionnaire({
              ...questionnaire,
              incorrectAnswers: [
                questionnaire.incorrectAnswers[0],
                e.target.value,
                questionnaire.incorrectAnswers[2],
              ],
            });
        ...
        <input
          ...
          type="text"
          placeholder="Write The Wrong Answer"
          value={questionnaire.incorrectAnswers[2]}
          onChange={(e) => {
            setQuestionnaire({
              ...questionnaire,
              incorrectAnswers: [
