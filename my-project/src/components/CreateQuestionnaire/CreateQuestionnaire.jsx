...
const CreateQuestionnaire = () => {
    ...
    return (
        <form className='flex flex-col p-5 gap-5 w-full' onSubmit={formik.handleSubmit}>
            <div className='flex '>
                <input 
                    type="text" 
                    name="question"
            ...
            <div className='flex flex-col gap-5 pl-5 '>
                ...
                {formik.values.incorrectAnswers.map((_, index) => (
                    <div key={index}>
                        ...
                        />
                        {formik.touched.incorrectAnswers && formik.errors.incorrectAnswers && formik.errors.incorrectAnswers[index] && (
                            <p className="text-red-500">{formik.errors.incorrectAnswers[index]}</p>
                        )}
                    </div>
                ))}
            </div>
